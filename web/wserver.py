    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/shitbroy">
          <h2 class="name">种子筛选</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/1715819"><i class="fab fa-github"></i></a>
        <a href="https://t.me/shitbroy"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
